...
#define MAX_CHUNK_NUM 256  // Usually around 200
...
#define CHUNK_DPT_OFFSET 17 // 1
#define NUM_CHANNELS_F 273// Default 3, RGB

#define MID_CONTRIB_OFFSET 0
#define CHUNK_NUM_OFFSET 1
